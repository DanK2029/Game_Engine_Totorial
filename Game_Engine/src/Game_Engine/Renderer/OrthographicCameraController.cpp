...
namespace GameEngine {
	...
	OrthographicCameraController::OrthographicCameraController(float apectRatio, bool rotation) 
		: m_AspectRatio(apectRatio), m_Camera(-m_AspectRatio * m_ZoomLevel, m_AspectRatio * m_ZoomLevel, -m_ZoomLevel, m_ZoomLevel), m_Rotation(rotation) {
